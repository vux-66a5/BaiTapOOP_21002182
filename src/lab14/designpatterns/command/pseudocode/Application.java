...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        app.activeEditor.replaceSelection("Test");
        System.out.println("selection của editor0 sau khi chọn \"Test\": " + app.activeEditor.getSelection());
        ...
        app.undoButton.onClick();
        System.out.println("selection của editor1 sau khi bấm nút undo: " + app.activeEditor.getSelection());
        app.activeEditor.replaceSelection("Test000000");
        System.out.println("selection của editor1 sau khi chọn \"Test000000\": " + app.activeEditor.getSelection());
